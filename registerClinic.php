...
<head>
    <meta charset="UTF-8">
    <title>Clinic Creation</title>
    <link rel="stylesheet" href="clinicStyles.css">
</head>
<body class="pageBody">
<div class="topofpage">
            ...
            <div id="col2">
                <div id="centerStuff">
                    ...
                    <form action method="post" enctype="multipart/form-data">
                        ...
                        <div id="label">Manager Password:</div> <div id="theInput"><input name="password" type="password"></div>
                        <div id="label">Repeat Password:</div> <div id="theInput"><input name="password2" type="password"></div>
                        <div id="label">Clinic Phone Number:</div> <div id="theInput"><input name="phone" type="tel"></div>
                        <div id="label">Clinic Name:</div> <div id="theInput"><input name="name" type="text"></div>
                        <div id="label">Clinic Location:</div><div id="theInput"><br> </div>
