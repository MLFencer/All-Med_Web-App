...
<head>
    <meta charset="UTF-8">
    <title>Emergency Room Creation</title>
    <link rel="stylesheet" href="erStyles.css">
</head>
<body class="pageBody">
<div class="topofpage">
            ...
            <div id="col2">
                <div id="centerStuff">
                    ...
                    <form action method="post" enctype="multipart/form-data">
                        ...
                        <div id="label">ER Phone Number:</div> <div id="theInput"><input name="phone" type="tel"></div>
                        <div id="label">ER Name:</div> <div id="theInput"><input name="name" type="text"></div>
                        <div id="label">ER Location:</div><div id="theInput"><br> </div>
